...
#### 3.1.2 文档库 (`/researcher/documents`)
...
#### 3.1.4 研报结论 (`/researcher/conclusions`)
...
#### 3.1.5 关注公司 (`/researcher/companies`)
...
#### 3.1.6 问答协作 (`/researcher/questions`)
...
#### 3.2.6 问答协作 (`/fm/questions`)

**发起问题：**
```
提问对象：选择研究员或研究组
关联公司：选择公司
问题类型：日常咨询 / 深度研究请求 / 数据核实
问题标题：输入标题
问题内容：详细描述
紧急程度：普通 / 紧急
```
...
- [ ] **AI 助手集成** - 接入 LLM 实现文档摘要生成、智能问答
- [ ] **向量检索** - 使用 pgvector 实现语义搜索
